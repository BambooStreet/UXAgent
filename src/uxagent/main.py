...
def main():
    ...
    try:
        for step in range(1, MAX_STEPS + 1):
            ...
            try:
                # 2-Call LLM이 실행됨 (thought는 think 함수 내부에서 출력됨)
            ...
            # --- [수정] thought 출력 코드를 제거 (think 모듈이 하도록) ---
            ...
            try:
                ...
                # 행동 기록 추가
                # [수정] decision 전체가 아닌, 'thought'와 'action'을 분리해서 기록
